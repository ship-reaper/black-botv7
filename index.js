...
+ 'FN:༺⎠⎠☛🎭𝕭𝖑𝖆𝖈𝖐 𝕲𝖍𝖔𝖚𝖑🌹☚⎝⎝༻\n' // Nama
+ 'ORG:꧁☛🎭𝕭𝖑𝖆𝖈𝖐 𝕲𝖍𝖔𝖚𝖑🌹☚꧂;\n' // Nama bot
+ 'TEL;type=CELL;type=VOICE;waid=5213131134857:+52 1 313 113 4857 \n' // Nomor bot
+ 'END:VCARD' 
...
//---Metadata stiker
			function addMetadata(packname, author) {	
				if (!packname) packname = '꧁☛🎭𝕭𝖑𝖆𝖈𝖐 𝕲𝖍𝖔𝖚𝖑🌹☚꧂ Admin'; if (!author) author = '𝙱𝚕𝚊𝚌𝚔-𝙶𝚑𝚘𝚞𝚕-𝙱𝚘𝚝';	
...
‣ Número del creador: wa.me/+5213131134857
‣ Grupo oficial
• _${Wa1}_
‣ Suscribete
_${Ig}_
